...
<body>
    ...
    <div class="hero-section" style="position: relative; text-align: left; color: white;">
        <img src="img/5.jpeg" class="d-block w-100" alt="Gambar 1">
        <div class="hero-caption" style="position: absolute; top: 50%; left: 10%; transform: translateY(-50%);">
            <h5 class="display-4 font-weight-bold animated fadeIn" style="font-family: 'Arial', sans-serif;">Sewa Dan Rental Mobil</h5>
